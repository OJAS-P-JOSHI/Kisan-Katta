export const translations = {
  ...
  mr: {
    ...
    'section.about.title': 'किसान कatta बद्दल',
    'section.about.subtitle':
    ...
    'section.features.subtitle':
      'हवामान सूचना ते बाजार भाव आणि समुदाय बाजारपेठ — किसान कatta हा तुमचा संपूर्ण शेती सहकारी.',
    'section.features.explore': 'सर्व वैशिष्ट्ये पहा',

    'section.why.eyebrow': 'का किसान कatta',
    'section.why.title': 'शेतकरी किसान कatta का निवडतात',
    'section.why.subtitle':
    ...
    'section.faq.subtitle':
      'किसान कatta आणि ग्राम सहकारी कार्यक्रमाबद्दल सामान्य प्रश्नांची उत्तरे.',
...
export function translate(locale: keyof typeof translations, key: TranslationKeys): string {
  return getNestedValue(translations[locale] as Record<string, string>, key)
}
