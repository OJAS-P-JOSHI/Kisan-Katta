...
export const profileStrings = {
  photo: {
    ...
    sizeExceeded: 'फोटोचा आकार ५ MB पेक्षा कमी असावा.',
    sizeExceededEn: 'Image size must be less than 5 MB.',
  ...
  legal: {
    ...
    aboutHint: 'Kissan Agrisathi आणि आमच्या संस्थापकांबद्दल',
  },
  summary: {
