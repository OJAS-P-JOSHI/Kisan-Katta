...
type ProofPhotoPickerProps = {
  photos: UseProofPhotosReturn;
  disabled?: boolean;
  onRetry?: () => void;
};

/** Proof photo tiles with the add tile, upload progress, and retry affordance. */
function ProofPhotoPickerComponent({ photos, disabled = false, onRetry }: ProofPhotoPickerProps) {
    ...
    <View style={styles.container}>
      <View style={styles.grid}>
        ...
        {canAddMore ? (
          <Pressable
            ...
            disabled={disabled || isUploading}
            accessibilityRole="button"
            accessibilityLabel={assistanceStrings.images.addPhoto}
          >
            ...
            >
              {assistanceStrings.images.addPhoto}
            </Text>
          </Pressable>
        ) : null}
      </View>
      ...
      {!canAddMore ? (
        <Text variant="bodySmall" style={{ color: theme.colors.onSurfaceVariant }}>
          {assistanceStrings.images.maxReached}
        </Text>
      ) : null}
      ...
      {isUploading && uploadProgress ? (
        <View style={styles.progressBlock}>
          ...
          />
          <Text variant="bodySmall" style={{ color: theme.colors.onSurfaceVariant }}>
            {assistanceStrings.images.uploadProgress(
      ...
      {uploadError ? (
        <View style={styles.errorBlock}>
          ...
          <Text variant="bodySmall" style={{ color: theme.colors.onSurfaceVariant }}>
            {assistanceStrings.images.uploadFailedHint}
          </Text>
          <Button
            mode="outlined"
            onPress={onRetry ?? clearUploadError}
            style={styles.retryButton}
            compact
          >
            {assistanceStrings.images.retry}
          </Button>
        </View>
      ) : null}
    </View>
...
export const ProofPhotoPicker = memo(ProofPhotoPickerComponent);
