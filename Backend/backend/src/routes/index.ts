...
import assistanceAdminRoutes from "../modules/assistance/assistance.admin.routes";
...
router.use("/api/v1/assistance", assistanceRoutes);
...
router.use("/api/v1/admin/assistance", assistanceAdminRoutes);
